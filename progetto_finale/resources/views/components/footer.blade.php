{{-- <div class="container min-vh-50 mb-0">
    <footer class="py-3 my-4">
        <ul class="nav justify-content-center border-bottom pb-3 mb-3">
            <li class="nav-item"><a href="{{ route('home') }}" class="nav-link px-2 text-body-secondary">Home</a></li>
            <li class="nav-item"><a href="{{ route('contacts') }}" class="nav-link px-2 text-body-secondary">Contacts</a>
            </li>
    ...
    <footer class=" bg-dark footer py-2">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-4 text-lg-start" style="color: rgb(212, 212, 212)">Copyright &copy; Your Website 2023
                </div>
