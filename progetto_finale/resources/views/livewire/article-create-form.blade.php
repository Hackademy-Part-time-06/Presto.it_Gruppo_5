{{-- <div class="margin-top p-4 container shadow">
    ...
    <form wire:submit.prevent="store">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" wire:model.lazy="title" id="input-title"
                value="{{ old('title') }}" aria-describedby="emailHelp">
        </div>

        <div class="mb-3">
            <label for="input-price" class="form-label">price</label>
            <input type="number" step="0.1" class="form-control" wire:model.lazy="price" id="input-price"
                value="{{ old('price') }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" wire:model.debounce.1000ms="description" id="input-description"
